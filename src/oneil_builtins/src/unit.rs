...
pub fn builtin_units_complete() -> impl Iterator<Item = (UnitBaseName, BuiltinUnit)> {
    ...
    let units = [
        ...
        UnitInfo {
            ...
            magnitude: 1.0,
            dimensions: DimensionMap::new(IndexMap::from([(Dimension::Rotation, 1.0)])),
            is_db: false,
            uses_prefixes: false,
        },
        // === DERIVED UNITS ===
        ...
        UnitInfo {
            ...
            magnitude: 1.0 / (2.0 * std::f64::consts::PI),
            dimensions: DimensionMap::new(IndexMap::from([(Dimension::Rotation, 1.0)])),
            is_db: false,
            uses_prefixes: true,
        },
